...
var carlos = new Usuario("Angel", 29, "as@as.com");
document.write(carlos.mostrarInfo());
var alejandro = new Usuario("Alejandro", 23, "ejemplo@correo.com");
document.write(alejandro.mostrarInfo());

var Estuadiante = /*#__PURE__*/function (_Usuario) {
  _inherits(Estuadiante, _Usuario);

  var _super = _createSuper(Estuadiante);

  function Estuadiante(nombre, edad, correo, carrera) {
    var _this;

    _classCallCheck(this, Estuadiante);
...
var maria = new Estuadiante("Maria", 30, "ejemplo2@correo.com", "Matematica");
